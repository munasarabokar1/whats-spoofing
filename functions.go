...
func sendSpoofedTalkDemo(chatJID types.JID, spoofedJID types.JID, toGender string, language string, spoofedFile string) {
	...
	msgmap["br"]["generic"][0] = "Wey iska waran..."
	msgmap["br"]["generic"][1] = "Ayaanta intee ka baxday..."
	msgmap["br"]["generic"][2] = "❤️❤️❤️❤️❤️"
	msgmap["br"]["generic"][3] = "Caadi iska dhig.."
	msgmap["br"]["generic"][4] = "Maxaa heesaa..."
	msgmap["br"]["generic"][5] = "Halagu arko..."
	msgmap["br"]["generic"][6] = "Warkaaga keen..."
	msgmap["br"]["boy"] = make(map[int]string)
	msgmap["br"]["boy"][0] = "Sxbow caadi iska dhig noh..."
	msgmap["br"]["boy"][1] = "Bye Bye Sxb!"
	msgmap["br"]["girl"] = make(map[int]string)
	msgmap["br"]["girl"][0] = "Waan kaa helay wlh..."
	msgmap["br"]["girl"][1] = "Ha igu adkeenin noh!"
